    ...
    <footer className="mt-16 border-t border-border bg-surface">
      <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6">
        <div className="grid gap-8 sm:grid-cols-3">
          ...
          <div>
            <p className="text-sm font-semibold text-ink">Pháp lý</p>
            <ul className="mt-3 space-y-2 text-sm">
              <li>
                <Link href={'/chinh-sach' as Route} className="text-muted-fg hover:text-primary">
        ...
        <p className="mt-8 border-t border-border pt-6 text-xs text-muted-fg">
          © {new Date().getFullYear()} News. Bài viết có thể chứa link affiliate.
        </p>
      </div>
    </footer>
  );
